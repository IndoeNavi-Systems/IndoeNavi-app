...
public class MapHandler {
    ...
    public Vec2 getLastKnownIndoorPosition(){
        return lastKnownIndoorPosition;
    }
    public Vec2 calculateIndoorPosition(TrackedSPE trackedSpe1, TrackedSPE trackedSpe2, TrackedSPE trackedSpe3){
        ...
        if (trackedSpe1.getSpe() == null || trackedSpe2.getSpe() == null || trackedSpe3.getSpe() == null){
            ...
            lastKnownIndoorPosition = calculateIndoorPosition(
